...
# HANSEL/GRETEL Node3 Pi - HANSEL_HEAD_AP static-IP join script
#
# Purpose:
#   Create/update a NetworkManager Wi-Fi profile so this Node3 Pi connects to
#   the Head Pi AP (HANSEL_HEAD_AP) with the FIXED address 192.168.4.13/24.
#
# Deployment address policy (MVP):
#   Head Pi AP   : 192.168.4.1   (gateway / DNS)
#   Node1 Pi     : 192.168.4.11
#   Node2 Pi     : 192.168.4.12
#   Node3 Pi     : 192.168.4.13  <-- THIS node
...
CON_NAME="hansel-ap"
STATIC_IP="192.168.4.13/24"
GATEWAY="192.168.4.1"
DNS="192.168.4.1"

log() { echo "[setup_static_ip:node3] $*"; }
